...
app="import {demoApi,subscribeDemo} from './demo-transport.mjs?v=0.5.1';\n"+app;
...
html=html.replace('点圆屏中央打开功能菜单；点四个分区查看任务。','点圆屏中央打开功能菜单；同一浏览器中的圆屏与工作台会同步。');
...
html=html.replace('href="./style.css"','href="./style.css?v=0.5.1"').replace('src="./app.js"','src="./app.js?v=0.5.1"');
